  ...
  return (
    <>
      ...
      <div className="estado">
        <button type="button" className="pendiente" onClick={() => setProgreso(0)}>
          Pendiente
        </button>

        <button type="button" className="proceso" onClick={() => setProgreso(50)}>
          En capacitación
        </button>

        <button type="button" className="capacitado" onClick={() => setProgreso(100)}>
          Capacitado
        </button>
      </div>
      ...
      <button type="button" onClick={() => setMostrarPlan(!mostrarPlan)}>
        {mostrarPlan ? "Ocultar plan de capacitación" : "Generar plan de capacitación"}
      </button>
